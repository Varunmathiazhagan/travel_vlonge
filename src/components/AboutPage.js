...
// NEW: DestinationsShowcaseSection component
const DestinationsShowcaseSection = () => {
  ...
  const destinations = [
    {
      icon: <FaMountain />,
      title: t("Adventure Expeditions", "about"),
      description: t("From Himalayan treks to Amazon explorations", "about"),
      gradient: "from-blue-500 to-indigo-600"
    },
    {
      icon: <FaUmbrellaBeach />,
      title: t("Beach Getaways", "about"),
      description: t("Pristine shores and tropical paradises", "about"),
      gradient: "from-cyan-500 to-blue-500"
    },
    {
      icon: <FaCity />,
      title: t("Urban Discoveries", "about"),
      description: t("Vibrant cityscapes and cultural hubs", "about"),
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {destinations.map((dest, index) => (
          <motion.div
            ...
            whileHover={{ y: -5 }}
          >
            <div className={`bg-gradient-to-br ${dest.gradient} p-8 h-full`}>
              <motion.div 
